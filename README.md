...
Meu nome é Alan de Oliveira Coutinho
...
---
Atualmente desenvolvo pesquisa em Astronomia, utilizando Machine Learning para classificação e análise de dados do levantamento LSST. (Para mais detalhes visite https://rubinobservatory.org/)

Participei no desenvolvimento de projetos junto ao [Grupo de Propriedades Ópticas e Térmicas de Materiais](https://sites.google.com/view/gpotm-ufu), nos seguintes temas:

* caracterização óptica de materiais;
* vidros dopados com íons terras-raras;
* termometria óptica utilizando materiais vítreos.
